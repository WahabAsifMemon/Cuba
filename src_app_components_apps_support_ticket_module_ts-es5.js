  ...
  (self["webpackChunkcuba"] = self["webpackChunkcuba"] || []).push([["src_app_components_apps_support_ticket_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _TicketComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 38,
        vars: 4,
        consts: [[3, "title", "items", "active_item"], [1, "container-fluid"], [1, "row"], [1, "col-sm-12"], [1, "card"], [1, "card-body"], [1, "form", "theme-form"], [1, "col"], [1, "form-group"], [1, "form-control", "digits"], ["type", "text", "placeholder", "Name client or company name", 1, "form-control"], ["id", "exampleFormControlTextarea4", "rows", "3", 1, "form-control"], [1, "form-group", "mb-0"], ["href", "#", 1, "btn", "btn-success", "mr-3"]],
