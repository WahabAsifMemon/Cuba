<?php $__env->startSection('title', 'Sign-up-wizard'); ?>
         ...
         <div>
            <div class="theme-form">
               <div class="wizard-4" id="wizard">
                  <ul>
                     <li><a class="logo text-start ps-0" href="<?php echo e(route('index')); ?>"><img class="img-fluid for-light" src="<?php echo e(asset('assets/images/logo/login.png')); ?>" alt="looginpage"><img class="img-fluid for-dark" src="<?php echo e(asset('assets/images/logo/logo_dark.png')); ?>" alt="looginpage"></a></li>
                     <li>
                        <a href="#step-1">
                           <h4>1</h4>
                           <h5>personal</h5>
                     ...
                     <li>                           <img src="<?php echo e(asset('assets/images/login/icon.png')); ?>" alt="looginpage"></li>
                  </ul>
                  <div id="step-1">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Laravel\Cuba\resources\views/authentication/sign-up-wizard.blade.php ENDPATH**/ ?>