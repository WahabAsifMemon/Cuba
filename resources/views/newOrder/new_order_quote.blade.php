...
@section('title', 'Digitizing Quote List')
...
<h3>New Digitizing Quote</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item">Digitizing Quote</li>
<li class="breadcrumb-item active">Create Digitizing Quote</li>
@endsection
